...
const DeliveryPriceComponent: FC<{ deliveryPrice: DeliveryPrice; saveHandler: (data: SaveDeliveryPrice) => void }> = ({
  deliveryPrice,
  saveHandler,
}) => {
  ...
  return (
    <div className={'flex flex-row items-center gap-8'}>
      ...
      <div className={'basis-1/5'}>
        {viewMode ? (
          <span>{deliveryPrice.stripeNaming}</span>
        ) : (
