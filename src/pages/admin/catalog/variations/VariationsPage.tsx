  ...
  return (
    <AdminLayout>
      ...
      <div className={'p-5'}>
        ...
        {navigationState === navigation.existed && (
          <ExistingVariation
            variants={variants}
        ...
        {navigationState === navigation.withoutVariation && (
          <div className={'flex flex-col gap-12 mb-24'}>
            ...
            {possibleVariation.length !== 0 && (
              <ChosenVariation
                products={possibleVariation}
                saveHandler={createVariation}
