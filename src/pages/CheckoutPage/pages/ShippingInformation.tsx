...
const ShippingInformation: FC<IProps> = ({ setData, buttonTitle, shippingData }) => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      receiverFirstName: shippingData?.receiverFirstName || '',
      receiverSecondName: shippingData?.receiverSecondName || '',
      ZIP: shippingData?.ZIP || 0,
      ASB: shippingData?.ASB || '',
      state: shippingData?.state || '',
      receiverPhoneNumber: shippingData?.receiverPhoneNumber || '',
