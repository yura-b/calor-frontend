...
const basketForNonRegisterUser = createSlice({
  ...
  export const { addToCartNonRegisterUser, removeFromCartNonRegisterUser, increaseQuantityNonRegisterUser, decreaseQuantityNonRegisterUser } = basketForNonRegisterUser.actions;
